...
Q:The average age of three boys is 15 years and their ages are in proportion 3:5:7. What is the age in years of the youngest boy?
O:['A)9', 'B)10', 'C)11', 'D)12', 'E)13']
x, y, z = symbols('x y z')
...
Q:Can you deduce the pattern and find the next number in the series?
6, 14, 26, 98, __?
O:['A)276', 'B)277', 'C)278', 'D)279', 'E)None of these']
n = symbols('n')
n=5
previous_term=98
...
Q:In covering a distance of 42 km, A takes 2 hours more than B. If A doubles his speed, then he would take 1 hour less than B. A's speed is:
O:['A)5 km/h', 'B)7 km/h', 'C)10 km/h', 'D)15 km/h', 'E)25 km/h']
a, b = symbols('a b')
...
Q:Let the number which when multiplied by 15 is increased by 196.
O:['A)14', 'B)20', 'C)26', 'D)28', 'E)30']
x = symbols('x')
...
Q:A certain sum of money at simple interest amounted Rs.980 in 3 years at 5% per annum, find the sum?
O:['A)867', 'B)855', 'C)299', 'D)852', 'E)903']
P = symbols('P')
A = 980  
R = 5
T = 3
...
#     #print("prompt:",template)
    ...
    template=template+input_example
